  ...
  return (
    <>
      <button
        type="button"
        onClick={handleClick}
        className="mt-3 inline-flex items-center gap-2 rounded-lg border border-white/[0.06] px-2.5 py-1.5 text-xs font-medium text-white/40 transition-all duration-150 hover:border-blood/60 hover:text-parchment active:scale-[0.96]"
      >
